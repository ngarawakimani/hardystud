...
class wp_booking_calendar_public_slot {
    ...
    public function getSlotDiscountPrice() {
        global $wpdb;
        global $blog_id;
        return wp_booking_calendar_public_slot::$slotQry[0]->slot_discount_price;
    }

    public function getSlotPercPrice() {
        global $wpdb;
        global $blog_id;
        return wp_booking_calendar_public_slot::$slotQry[0]->slot_perc_price;
    }

    public function getSlotShowPrice() {
        global $wpdb;
        global $blog_id;
        return wp_booking_calendar_public_slot::$slotQry[0]->slot_show_price;
    }
