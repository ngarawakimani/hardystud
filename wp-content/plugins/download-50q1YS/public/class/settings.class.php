...
class wp_booking_calendar_public_setting {
	...
	public function getNameFromReservation() {
		global $wpdb;
		global $blog_id;
		return get_option('wbc_name_from_reservation');
	}

	public function getRedirectBookingPath() {
		global $wpdb;
		global $blog_id;
		return get_option('wbc_redirect_booking_path');
	}
    ...
    public function getRecaptchaVersion() {
        global $wpdb;
        global $blog_id;
        return wp_booking_calendar_public_setting::doSettingQuery('recaptcha_version');
    }
	...
	public function getRedirect() {
		global $wpdb;
		global $blog_id;
		return get_option('wbc_redirect_confirmation_path');
	}
	...
	public function getCancelRedirect() {
		global $wpdb;
		global $blog_id;
		return get_option('wbc_redirect_cancel_path');
	}
	...
	public function getTermsLabel() {
		global $wpdb;
		global $blog_id;
		return get_option('wbc_terms_label');
	}
	
	public function getTermsLink() {
		global $wpdb;
		global $blog_id;
		return get_option('wbc_terms_link');
	}
	...
	public function getFormText() {
		global $wpdb;
		global $blog_id;
		return get_option('wbc_form_text');
	}
	
	public function getReservationConfirmationModeOverride() {
		global $wpdb;
		global $blog_id;
		return wp_booking_calendar_public_setting::doSettingQuery('reservation_confirmation_mode_override');
	}
	
	public function getReservationAfterPayment() {
		global $wpdb;
		global $blog_id;
		return wp_booking_calendar_public_setting::doSettingQuery('reservation_after_payment');
	}
    ...
    public function getDayNamesBg() {
        global $wpdb;
        global $blog_id;
        return stripslashes(wp_booking_calendar_public_setting::doSettingQuery('day_names_bg'));
    }

    public function getDayBorder() {
        global $wpdb;
        global $blog_id;
        return stripslashes(wp_booking_calendar_public_setting::doSettingQuery('day_border'));
    }
    ...
    public function getDayWhiteLine2DisabledBg() {
        global $wpdb;
        global $blog_id;
        return stripslashes(wp_booking_calendar_public_setting::doSettingQuery('day_white_line2_disabled_bg'));
    }
    ...
    public function getDayWhiteLine2Bg() {
        global $wpdb;
        global $blog_id;
        return stripslashes(wp_booking_calendar_public_setting::doSettingQuery('day_white_line2_bg'));
    }

    public function getDayWhiteLine2BgHover() {
        global $wpdb;
        global $blog_id;
        return stripslashes(wp_booking_calendar_public_setting::doSettingQuery('day_white_line2_bg_hover'));
    }
    ...
    public function getDayRedLine2Bg() {
        global $wpdb;
        global $blog_id;
        return stripslashes(wp_booking_calendar_public_setting::doSettingQuery('day_red_line2_bg'));
    }
    ...
    public function getMonthNavigationButtonColor() {
        global $wpdb;
        global $blog_id;
        return stripslashes(wp_booking_calendar_public_setting::doSettingQuery('month_navigation_button_color'));
    }

    public function getMonthNavigationButtonColorHover() {
        global $wpdb;
        global $blog_id;
        return stripslashes(wp_booking_calendar_public_setting::doSettingQuery('month_navigation_button_color_hover'));
    }
	...
	public function getRegistrationText() {
		global $wpdb;
		global $blog_id;
		return get_option('wbc_registration_text');
	}

    public function getGoogleFontCssCode() {
        global $wpdb;
        global $blog_id;
        return stripslashes(wp_booking_calendar_public_setting::doSettingQuery('google_font_css_code'));
    }

    public function getGoogleFontLinkCode() {
        global $wpdb;
        global $blog_id;
        return stripslashes(wp_booking_calendar_public_setting::doSettingQuery('google_font_link_code'));
    }
