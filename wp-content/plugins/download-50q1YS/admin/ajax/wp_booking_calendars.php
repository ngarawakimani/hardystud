...
<div class="booking_border_b_1 booking_border_solid booking_border_ccc booking_bg_f6f booking_height_30 booking_line_30">
    ...
    <div class="booking_float_left booking_width_25p"><?php echo __( 'Title', 'wp-booking-calendar' ); ?></div>
    
    <div class="booking_float_left booking_width_20p"><?php echo __( 'Category', 'wp-booking-calendar' ); ?></div>
    
    <div class="booking_float_left booking_width_20p"><?php echo __( 'Shortcode', 'wp-booking-calendar' ); ?></div>
   
    <div class="booking_float_left booking_width_10p"><?php echo __( 'Published', 'wp-booking-calendar' ); ?></div>
...
<div id="row_<?php echo $calendarId; ?>" class="booking_border_b_1 booking_border_solid booking_border_ccc">
    ...
    <div class="booking_float_left booking_width_10p booking_height_60 <?php echo $class; ?>">
        <div class="booking_wh_inherit booking_table_cell booking_vertical_middle">
            <span id="publish_<?php echo $calendarId; ?>"><?php if($calendar["calendar_active"]=='1') { ?><a href="javascript:unpublishCalendar(<?php echo $calendarId; ?>);"><img src="<?php echo BOOKING_ADMIN_URL;?>images/icons/published.png" border=0 /></a><?php } else { ?><a href="javascript:publishCalendar(<?php echo $calendarId; ?>);"><img src="<?php echo BOOKING_ADMIN_URL;?>images/icons/unpublished.png" border=0 /></a><?php } ?></span>
            <?php
            if($calendar["calendar_order"] > 0) {
            ?>
            <br /><input type="button" value="<?php echo __( 'Set as default', 'wp-booking-calendar' ); ?>" onclick="javascript:setDefaultCalendar(<?php echo $calendarId; ?>,<?php echo $calendar["category_id"]; ?>);" class="booking_font_12"/>
            <?php
            }
            ?>
        </div>
    ...
    <div class="booking_float_left booking_width_5p booking_height_60 <?php echo $class; ?>">
        <div class="booking_wh_inherit booking_table_cell booking_vertical_middle">
            <span id="modify_<?php echo $calendarId; ?>"><a href="?page=wp-booking-calendar&file=new_calendar&calendar_id=<?php echo $calendarId; ?>"><?php echo __( 'Modify', 'wp-booking-calendar' ); ?></a></span>
        </div>
    </div>
    
    <!-- manage button -->
    <div class="booking_float_left booking_width_5p booking_height_60 <?php echo $class; ?>">
        <div class="booking_wh_inherit booking_table_cell booking_vertical_middle"><a href="?page=wp-booking-calendar&calendar_id=<?php echo $calendarId; ?>&ref=slots"><?php echo __( 'Manage', 'wp-booking-calendar' ); ?></a></div>
    </div>
    
    <!-- delete button -->
    <div class="booking_float_left booking_width_5p booking_height_60 <?php echo $class; ?>">
        <div class="booking_wh_inherit booking_table_cell booking_vertical_middle"><a href="javascript:delItem(<?php echo $calendarId; ?>,'calendars','calendar_id');"><?php echo __( 'Delete', 'wp-booking-calendar' ); ?></a></div>
    </div>                            
