...
class wp_booking_calendar_email {
	...
	public function updateMail() {
		...
		do_action( 'wpml_register_string', $_POST["mail_subject"], "mail_subject_".$this->getMailId(), $package, "Mail '".$this->getMailName()."' Subject", 'LINE' );
		do_action( 'wpml_register_string', $_POST["mail_text"], "mail_text_".$this->getMailId(), $package, "Mail '".$this->getMailName()."' text", 'AREA' );
		do_action( 'wpml_register_string', $mail_cancel_text, "mail_cancel_text_".$this->getMailId(), $package, "Mail '".$this->getMailName()."' cancellation text", 'AREA' );
		do_action( 'wpml_register_string', $_POST["mail_signature"], "mail_signature_".$this->getMailId(), $package, "Mail '".$this->getMailName()."' signature", 'AREA' );
