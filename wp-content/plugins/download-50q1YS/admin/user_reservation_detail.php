    ...
    <div class="booking_margin_t_20">
            ...
            <div class="booking_margin_t_20 booking_bg_f6f booking_border_1 booking_border_solid booking_border_ccc booking_padding_10">
                <div class="booking_float_right">
                    <div class="booking_float_left"><a href="?page=wp-booking-calendar-orders" class="booking_float_left booking_margin_l_20 booking_mark_333 booking_pointer booking_font_bold"><?php echo __( 'Close', 'wp-booking-calendar' ); ?></a></div>
            ...
            <div class="booking_bg_f6f booking_border_1 booking_border_solid booking_border_ccc booking_margin_t_20" id="detail_page">
				...
				if(in_array("reservation_surname",$bookingSettingObj->getVisibleFields())) { 
					?>
					<div class="booking_bg_fff booking_float_left booking_width_30p booking_height_30 booking_line_30 booking_padding_l_1p"><?php echo __( 'Surname', 'wp-booking-calendar' ); ?></div>
