...
class Tribe__Events__iCal {
	...
	public function single_event_links() {
		...
		echo '<br><i style="color:red;">' .esc_html__( 'Export Event to your google calendar', 'the-events-calendar' ). '</i></br>';
		echo '<a class="tribe-events-gcal tribe-events-button" href="' . Tribe__Events__Main::instance()->esc_gcal_url( tribe_get_gcal_link() ) . '" title="' . esc_attr__( 'Add to Google Calendar', 'the-events-calendar' ) . '">+ ' . esc_html__( 'Export Event', 'the-events-calendar' ) . '</a>';
		echo '<a class="tribe-events-ical tribe-events-button" href="' . esc_url( tribe_get_single_ical_link() ) . '" title="' . esc_attr__( 'Download .ics file', 'the-events-calendar' ) . '" >+ ' . esc_html__( 'Download iCal Calendar', 'the-events-calendar' ) . '</a>';
