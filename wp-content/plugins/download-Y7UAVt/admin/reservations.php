...
if(isset($_GET["calendar_id"])) {
	...
	<div class="booking_padding_20 booking_font_14 booking_line_percent booking_bg_fff">
		...
		<div class="booking_font_bold"><?php echo __( 'Reservations', 'wp-booking-calendar' ); ?></div>
		...
		<div class="booking_margin_t_20">
			   <div id="table" class="booking_font_12">
					...
					<div class="booking_border_b_1 booking_border_solid booking_border_ccc booking_bg_f6f booking_height_30 booking_line_30">
						...
						<!-- calendar -->
						<div class="booking_float_left booking_width_20p"><?php echo __( 'Calendar', 'wp-booking-calendar' ); ?></div>
						
								  
						<!-- reservations -->
						<div class="booking_float_left booking_width_10p"><?php echo __( 'Reservations', 'wp-booking-calendar' ); ?></div>
					...
					<div class="booking_float_left booking_width_10p booking_height_50  <?php echo $class; ?>">
						<div class="booking_wh_inherit booking_table_cell booking_vertical_middle">
							<?php if($calendar["calendar_active"]=='1') { ?><img src="<?php echo BOOKING_ADMIN_URL;?>images/icons/published.png" border=0 /><?php } else { ?><img src="<?php echo BOOKING_ADMIN_URL;?>images/icons/unpublished.png" border=0 /><?php } ?>
						</div>
					</div> 
					...
					<div class="booking_float_left booking_width_10p booking_height_50  <?php echo $class; ?>">
						<div class="booking_wh_inherit booking_table_cell booking_vertical_middle">
							...
							if($calendar["tot_reservation"]>0) {
								?>
								<a href="?page=wp-booking-calendar-reservations&calendar_id=<?php echo $calendarId; ?>"><?php echo __( 'List', 'wp-booking-calendar' ); ?></a>
								<?php
							}
							?>
						</div>
