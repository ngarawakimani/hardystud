    ...
    <div class="booking_margin_t_20">
            ...
            <div class="booking_margin_t_20 booking_bg_f6f booking_border_1 booking_border_solid booking_border_ccc booking_padding_10">
                <div class="booking_float_right">
                    <div class="booking_float_left"><a href="?page=wp-booking-calendar-reservations&calendar_id=<?php echo $bookingReservationObj->getReservationCalendarId(); ?>" class="booking_float_left booking_margin_l_20 booking_mark_333 booking_pointer booking_font_bold"><?php echo __( 'Close', 'wp-booking-calendar' ); ?></a></div>
                    <div class="booking_float_left"><a onclick="printDiv('detail_page')" class="booking_float_left booking_margin_l_20 booking_mark_333 booking_pointer booking_font_bold"><?php echo __( 'Print', 'wp-booking-calendar' ); ?></a></div>
                </div>
            ...
            <div class="booking_bg_f6f booking_border_1 booking_border_solid booking_border_ccc booking_margin_t_20" id="detail_page">
				...
				if(in_array("reservation_surname",$bookingSettingObj->getVisibleFields())) { 
					?>
					<div class="booking_bg_fff booking_float_left booking_width_30p booking_height_30 booking_line_30 booking_padding_l_1p" id="title_row_detail"><?php echo __( 'Surname', 'wp-booking-calendar' ); ?></div>
				...
				if(in_array("reservation_name",$bookingSettingObj->getVisibleFields())) { 
					?>
					<div class="booking_bg_f6f booking_float_left booking_width_30p booking_height_30 booking_line_30 booking_padding_l_1p" id="title_row_detail"><?php echo __( 'Name', 'wp-booking-calendar' ); ?></div>
				...
				if(in_array("reservation_email",$bookingSettingObj->getVisibleFields())) { 
					?>
					<div class="booking_bg_fff booking_float_left booking_width_30p booking_height_30 booking_line_30 booking_padding_l_1p" id="title_row_detail"><?php echo __( 'Email', 'wp-booking-calendar' ); ?></div>
				...
				if(in_array("reservation_phone",$bookingSettingObj->getVisibleFields())) { 
					?>
					<div id="title_row_detail" class="booking_bg_f6f booking_float_left booking_width_30p booking_height_30 booking_line_30 booking_padding_l_1p"><?php echo __( 'Phone', 'wp-booking-calendar' ); ?></div>
				...
				if(in_array("reservation_message",$bookingSettingObj->getVisibleFields())) { 
					?>
					<div id="title_row_detail" class="booking_bg_fff booking_float_left booking_width_30p booking_height_30 booking_line_30 booking_padding_l_1p"><?php echo __( 'Message', 'wp-booking-calendar' ); ?></div>
				...
				if(in_array("reservation_field1",$bookingSettingObj->getVisibleFields())) { 
					?>
					<div id="title_row_detail" class="booking_bg_f6f booking_float_left booking_width_30p booking_height_30 booking_line_30 booking_padding_l_1p"><?php echo __( 'Additional field 1', 'wp-booking-calendar' ); ?></div>
				...
				if(in_array("reservation_field2",$bookingSettingObj->getVisibleFields())) { 
					?>
					<div id="title_row_detail" class="booking_bg_fff booking_float_left booking_width_30p booking_height_30 booking_line_30 booking_padding_l_1p"> <?php echo __( 'Additional field 2', 'wp-booking-calendar' ); ?></div>
				...
				if(in_array("reservation_field3",$bookingSettingObj->getVisibleFields())) { 
					?>
					<div id="title_row_detail" class="booking_bg_f6f booking_float_left booking_width_30p booking_height_30 booking_line_30 booking_padding_l_1p"><?php echo __( 'Additional field 3', 'wp-booking-calendar' ); ?></div>
				...
				if(in_array("reservation_field4",$bookingSettingObj->getVisibleFields())) { 
					?>
					<div id="title_row_detail" class="booking_bg_fff booking_float_left booking_width_30p booking_height_30 booking_line_30 booking_padding_l_1p"><?php echo __( 'Additional field 4', 'wp-booking-calendar' ); ?></div>
                ...
                <div id="title_row_detail" class="booking_bg_f6f booking_float_left booking_width_30p booking_height_30 booking_line_30 booking_padding_l_1p"><?php echo __( 'Date', 'wp-booking-calendar' ); ?></div>
                ...
                <div id="title_row_detail" class="booking_bg_fff booking_float_left booking_width_30p booking_height_30 booking_line_30 booking_padding_l_1p"><?php echo __( 'Time', 'wp-booking-calendar' ); ?></div>
				...
				if($bookingSettingObj->getSlotsUnlimited() == 2) {
					?>
					<div id="title_row_detail" class="booking_bg_f6f booking_float_left booking_width_30p booking_height_30 booking_line_30 booking_padding_l_1p"><?php echo __( 'Seats', 'wp-booking-calendar' ); ?></div>
				...
				if($bookingSlotsObj->getSlotPrice() >0) {
					?>
					<div id="title_row_detail" class="booking_bg_f6f booking_float_left booking_width_30p booking_height_30 booking_line_30 booking_padding_l_1p"><?php echo __( 'Price', 'wp-booking-calendar' ); ?></div>
                ...
                <div id="title_row_detail" class="booking_bg_fff booking_float_left booking_width_30p booking_height_30 booking_line_30 booking_padding_l_1p" ><?php echo __( 'Confirmed', 'wp-booking-calendar' ); ?></div>
                <div id="row_detail" class="booking_bg_fff booking_float_left booking_width_69p booking_height_30 booking_line_30">
                    <?php 
					if($bookingReservationObj->getReservationConfirmed() == 1) {
						echo __( 'YES', 'wp-booking-calendar' );
					} else {
						echo __( 'NO', 'wp-booking-calendar' );
					}
					?>
                </div>
                ...
                <div class="booking_cleardiv"></div>
                <div id="title_row_detail" class="booking_bg_f6f booking_float_left booking_width_30p booking_height_30 booking_line_30 booking_padding_l_1p"><?php echo __( 'Cancelled', 'wp-booking-calendar' ); ?></div>
                <div id="row_detail" class="booking_bg_f6f booking_float_left booking_width_69p booking_height_30 booking_line_30">
                    <?php 
