...
if($_REQUEST["add_dates"]==1) {
	...
	if($newid != '0') {
		...
		<div id="row_<?php echo $newid; ?>">
			...
			<div class="booking_float_left booking_width_20p booking_height_50 <?php echo $newclass; ?>">
				<div class="booking_wh_inherit booking_table_cell booking_vertical_middle"><a href="javascript:delItem(<?php echo $newid; ?>,'holidays','holiday_id');"><?php echo __( 'Delete', 'wp-booking-calendar' ); ?></a></div>
			</div>
	...
	for($i=0;$i<count($arrNewIds);$i++) {
		...
		<div id="row_<?php echo $arrNewIds[$i]; ?>">
			...
			<div class="booking_float_left booking_width_20p booking_height_50 <?php echo $newclass; ?>">
				<div class="booking_wh_inherit booking_table_cell booking_vertical_middle"><a href="javascript:delItem(<?php echo $arrNewIds[$i]; ?>,'holidays','holiday_id');"><?php echo __( 'Delete', 'wp-booking-calendar' ); ?></a></div>
			</div>
			<div class="booking_cleardiv"></div>
		</div>
		<?php
