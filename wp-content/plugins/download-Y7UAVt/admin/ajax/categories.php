...
<div class="booking_border_b_1 booking_border_solid booking_border_ccc booking_bg_f6f booking_height_30 booking_line_30">
    ...
    <div class="booking_float_left booking_width_40p"><?php echo __( 'Name', 'wp-booking-calendar' ); ?></div>
...
<div id="row_<?php echo $categoryId; ?>" class="booking_border_b_1 booking_border_solid booking_border_ccc">
    ...
    <div class="booking_float_left booking_width_10p booking_height_60 <?php echo $class; ?>">
        <div class="booking_wh_inherit booking_table_cell booking_vertical_middle">
            <span id="publish_<?php echo $categoryId; ?>"><?php if($category["category_active"]=='1') { ?><a href="javascript:unpublishCategory(<?php echo $categoryId; ?>);"><img src="<?php echo BOOKING_ADMIN_URL;?>images/icons/published.png" border=0 /></a><?php } else { ?><a href="javascript:publishCategory(<?php echo $categoryId; ?>);"><img src="<?php echo BOOKING_ADMIN_URL;?>images/icons/unpublished.png" border=0 /></a><?php } ?></span>
            <?php
            if($category["category_order"] > 0) {
            ?>
            <br /><input type="button" value="<?php echo __( 'Set as default', 'wp-booking-calendar' ); ?>" onclick="javascript:setDefaultCategory(<?php echo $categoryId; ?>);" class="booking_font_12"/>
            <?php
            }
            ?>
        </div>
    ...
    <div class="booking_float_left booking_width_10p booking_height_60 <?php echo $class; ?>">
        <div class="booking_wh_inherit booking_table_cell booking_vertical_middle">
            <span id="modify_<?php echo $categoryId; ?>"><a href="javascript:editItem(<?php echo $categoryId; ?>);"><?php echo __( 'Modify name', 'wp-booking-calendar' ); ?></a></span>
        </div>
    </div>
    
    <!-- delete button -->
    <div class="booking_float_left booking_width_10p booking_height_60 <?php echo $class; ?>">
        <div class="booking_wh_inherit booking_table_cell booking_vertical_middle"><a href="javascript:delItem(<?php echo $categoryId; ?>,'categories','category_id');"><?php echo __( 'Delete', 'wp-booking-calendar' ); ?></a></div>
    </div>                            
