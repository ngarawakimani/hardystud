...
if(isset($_GET["upload"]) && $_GET["upload"] == 1) {
	...
	include 'lang_text_import.php';
} else if(isset($_GET["import"]) && $_GET["import"] == 0) {
	...
	<div class="booking_padding_20 booking_font_18 booking_line_percent booking_bg_fff">
			...
			<div id="texts_1" style="display:none !important">
				<form name="edittexts" action="<?php echo BOOKING_ADMIN_URL;?>ajax/saveTexts.php" method="post" tmt:validate="true" enctype="multipart/form-data" onsubmit="return showLoader();" target="iframe_submit">
				<?php
