...
class wp_booking_calendar_public_calendar {
	...
	public function getCalendarTitle() {
		global $wpdb;
		global $blog_id;
		$translated_string = apply_filters( 'wpml_translate_single_string', stripslashes(wp_booking_calendar_public_calendar::$calendarQry[0]->calendar_title), 'wp-booking-calendar-calendars', "calendar_".$this->getCalendarId() );
