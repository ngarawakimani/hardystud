...
class wp_booking_calendar_public_category {
	...
	public function getCategoryName() {
		global $wpdb;
		global $blog_id;
		$translated_string = apply_filters( 'wpml_translate_single_string', stripslashes(wp_booking_calendar_public_category::$categoryQry[0]->category_name), "wp-booking-calendar-categories", "category_".$this->getCategoryId() );
		return ;
	}
