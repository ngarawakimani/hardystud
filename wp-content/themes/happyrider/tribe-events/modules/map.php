...
?>
<div id="tribe-events-gmap-<?php esc_attr_e( $index, 'happyrider','happyrider') ?>" style="<?php esc_attr_e( $style, 'happyrider','happyrider' ) ?>"></div><!-- #tribe-events-gmap-<?php esc_attr_e( $index, 'happyrider','happyrider' ) ?> -->
