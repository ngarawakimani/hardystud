...
if ( !function_exists( 'happyrider_exists_visual_composer' ) ) {
	function happyrider_exists_visual_composer() {
		return class_exists('Vc_Manager');
	}
}

// Check if Visual Composer in frontend editor mode
if ( !function_exists( 'happyrider_vc_is_frontend' ) ) {
	function happyrider_vc_is_frontend() {
