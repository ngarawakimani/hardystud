...
if ( !function_exists( 'happyrider_template_services_4_theme_setup' ) ) {
	add_action( 'happyrider_action_before_init_theme', 'happyrider_template_services_4_theme_setup', 1 );
	function happyrider_template_services_4_theme_setup() {
		happyrider_add_template(array(
			'layout' => 'services-4',
			'template' => 'services-4',
			'mode'   => 'services',
			'need_columns' => true,
			'title'  => __('Services /Style 4/', 'happyrider')
		));
	}
}

// Template output
if ( !function_exists( 'happyrider_template_services_4_output' ) ) {
	function happyrider_template_services_4_output($post_options, $post_data) {
		$show_title = true;
