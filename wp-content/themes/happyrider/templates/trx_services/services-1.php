...
if ( !function_exists( 'happyrider_template_services_1_theme_setup' ) ) {
	add_action( 'happyrider_action_before_init_theme', 'happyrider_template_services_1_theme_setup', 1 );
	function happyrider_template_services_1_theme_setup() {
		happyrider_add_template(array(
			'layout' => 'services-1',
			'template' => 'services-1',
			'mode'   => 'services',
			'title'  => __('Services /Style 1/', 'happyrider'),
...
// Template output
if ( !function_exists( 'happyrider_template_services_1_output' ) ) {
	function happyrider_template_services_1_output($post_options, $post_data) {
		$show_title = true;
