...
if ( !function_exists( 'happyrider_template_team_1_theme_setup' ) ) {
	add_action( 'happyrider_action_before_init_theme', 'happyrider_template_team_1_theme_setup', 1 );
	function happyrider_template_team_1_theme_setup() {
		happyrider_add_template(array(
			'layout' => 'team-1',
			'template' => 'team-1',
			'mode'   => 'team',
			'title'  => __('Team /Style 1/', 'happyrider'),
...
// Template output
if ( !function_exists( 'happyrider_template_team_1_output' ) ) {
	function happyrider_template_team_1_output($post_options, $post_data) {
		$show_title = true;
		...
		?>
			<div<?php echo ($post_options['tag_id'] ? ' id="'.esc_attr($post_options['tag_id']).'"' : ''); ?>
				...
				<div class="sc_team_item_info">
					...
					<div class="sc_team_item_description"><?php echo trim(happyrider_strshort($post_data['post_excerpt'], isset($post_options['descr']) ? $post_options['descr'] : happyrider_get_custom_option('post_excerpt_maxlength_masonry'))); ?></div>
