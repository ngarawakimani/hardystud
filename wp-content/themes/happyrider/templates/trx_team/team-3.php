...
if ( !function_exists( 'happyrider_template_team_3_theme_setup' ) ) {
	add_action( 'happyrider_action_before_init_theme', 'happyrider_template_team_3_theme_setup', 1 );
	function happyrider_template_team_3_theme_setup() {
		happyrider_add_template(array(
			'layout' => 'team-3',
			'template' => 'team-3',
			'mode'   => 'team',
			'title'  => __('Team /Style 3/', 'happyrider'),
...
// Template output
if ( !function_exists( 'happyrider_template_team_3_output' ) ) {
	function happyrider_template_team_3_output($post_options, $post_data) {
		$show_title = true;
