...
if ( !function_exists( 'happyrider_template_testimonials_2_theme_setup' ) ) {
	add_action( 'happyrider_action_before_init_theme', 'happyrider_template_testimonials_2_theme_setup', 1 );
	function happyrider_template_testimonials_2_theme_setup() {
		happyrider_add_template(array(
			'layout' => 'testimonials-2',
			'template' => 'testimonials-2',
			'mode'   => 'testimonials',
			'title'  => __('Testimonials /Style 2/', 'happyrider')
		));
	}
}

// Template output
if ( !function_exists( 'happyrider_template_testimonials_2_output' ) ) {
	function happyrider_template_testimonials_2_output($post_options, $post_data) {
		$show_title = true;
