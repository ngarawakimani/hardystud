...
if ( !function_exists( 'happyrider_template_testimonials_4_theme_setup' ) ) {
	add_action( 'happyrider_action_before_init_theme', 'happyrider_template_testimonials_4_theme_setup', 1 );
	function happyrider_template_testimonials_4_theme_setup() {
		happyrider_add_template(array(
			'layout' => 'testimonials-4',
			'template' => 'testimonials-4',
			'mode'   => 'testimonials',
			'title'  => __('Testimonials /Style 4/', 'happyrider'),
...
// Template output
if ( !function_exists( 'happyrider_template_testimonials_4_output' ) ) {
	function happyrider_template_testimonials_4_output($post_options, $post_data) {
		$show_title = true;
