...
if ( !function_exists( 'happyrider_template_testimonials_1_theme_setup' ) ) {
	add_action( 'happyrider_action_before_init_theme', 'happyrider_template_testimonials_1_theme_setup', 1 );
	function happyrider_template_testimonials_1_theme_setup() {
		happyrider_add_template(array(
			'layout' => 'testimonials-1',
			'template' => 'testimonials-1',
			'mode'   => 'testimonials',
			'title'  => __('Testimonials /Style 1/', 'happyrider'),
...
// Template output
if ( !function_exists( 'happyrider_template_testimonials_1_output' ) ) {
	function happyrider_template_testimonials_1_output($post_options, $post_data) {
		$show_title = true;
