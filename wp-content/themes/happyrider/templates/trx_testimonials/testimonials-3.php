...
if ( !function_exists( 'happyrider_template_testimonials_3_theme_setup' ) ) {
	add_action( 'happyrider_action_before_init_theme', 'happyrider_template_testimonials_3_theme_setup', 1 );
	function happyrider_template_testimonials_3_theme_setup() {
		happyrider_add_template(array(
			'layout' => 'testimonials-3',
			'template' => 'testimonials-3',
			'mode'   => 'testimonials',
			'title'  => __('Testimonials /Style 3/', 'happyrider'),
			'thumb_title'  => __('Avatar (small)', 'happyrider'),
			'w'		 => 75,
			'h'		 => 75
		));
	}
...
// Template output
if ( !function_exists( 'happyrider_template_testimonials_3_output' ) ) {
	function happyrider_template_testimonials_3_output($post_options, $post_data) {
		$show_title = true;
